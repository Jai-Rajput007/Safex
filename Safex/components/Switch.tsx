...
const StyledWrapper = styled.div`
 .theme-switch {
  --toggle-size: 15px; /* Further reduced the base size */
  --container-width: 3em; /* Further reduced the width */
  --container-height: 1.5em; /* Further reduced the height */
  --container-radius: 0.75em; /* Further reduced the radius */
  --container-light-bg: #3D7EAE;
  --container-night-bg: #1D1F2C;
  --circle-container-diameter: 1.8em; /* Further reduced the diameter */
  --sun-moon-diameter: 1em; /* Further reduced the diameter */
  --sun-bg: #ECCA2F;
  --moon-bg: #C4C9D1;
  --spot-color: #959DB1;
