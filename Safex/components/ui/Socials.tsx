  ...
  return (
    <StyledWrapper className={className}>
      <div className="card">
        ...
        <a className="social-link" href="https://tiktok.com" target="_blank" rel="noopener noreferrer">
        ...
        <a className="social-link" href="https://discord.com" target="_blank" rel="noopener noreferrer">
        ...
        <a className="social-link" href="https://github.com" target="_blank" rel="noopener noreferrer">
